...
const MyApplications = () => {
  ...
  const filteredApplications = applications.filter(app => {
    ...
    const matchesSearch = !searchTerm || 
      ...
      formatDate(app.submittedAt).toLowerCase().includes(searchLower) ||
        ...
        <div className="d-flex justify-content-between align-items-center p-3 border-bottom bg-white">
          ...
          <div className="d-flex align-items-center gap-3">
            <div className="d-flex align-items-center gap-2">
              <span className="badge bg-info">Client View</span>
            </div>
          ...
          <div className="row g-3 align-items-center">
            ...
            <div className="col-md-2">
              <button 
                ...
                onClick={() => fetchApplications(localStorage.getItem("token"))}
                disabled={loading}
              >
                      ...
                      <td colSpan="6" className="text-center py-4">
                        <div className="text-muted">
                          ...
                          {searchTerm || filterStatus !== "all" || filterPaymentStatus !== "all" ? 
                            ...
                            "No applications found. Start by applying for services from the dashboard."}
                        </div>
                      </td>
                    </tr>
                  ) : (
                    filteredApplications.map((app) => (
                      <tr key={app.id || app._id}>
                        <td>
                          ...
                          <small className="text-muted">ID: {app.id || app._id}</small>
                        </td>
                        <td>
                        ...
                        <td>
                          <div className="d-flex gap-1 flex-wrap">
                            <button 
                              ...
                              onClick={() => navigate(`/application-details/${app.id || app._id}`)}
                              title="View Details"
                            >
                            ...
                            {app.paymentStatus === 'pending' && (
                              <button 
                                ...
                                onClick={() => navigate(`/payment/${app.id || app._id}`)}
                                title="Make Payment"
                              >
